...
namespace _4_DTNhatNMPhuongPTNguyenNVNam_LTNET
{
    public partial class frm_HoaDon_Nguyen : Form
    {
        ...
        private void XemChiTiet(string maHD,string Hoten,string nhanvien,DateTime ngaythue,DateTime ngaytra)
        {
            frm_chitiet_Nhat formChiTiet = new frm_chitiet_Nhat(maHD,Hoten,nhanvien,ngaythue,ngaytra);
        ...
        private void btn_chitiet_Nhat_Click(object sender, EventArgs e)
        {
            ...
            XemChiTiet(maHD,hoten,Nhanvien,ngaythue,ngaytra);
        }
