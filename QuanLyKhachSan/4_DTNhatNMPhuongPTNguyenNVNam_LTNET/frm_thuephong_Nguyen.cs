    ...
    public partial class frm_thuephong_Nguyen : Form
    {
        ...
        private void hienthiphong()
        {
            ...
            foreach (string[] phong in danhSachPhong)
            {
                ...
                //btnPhong.Image = Image.FromFile(@"C:\Users\ACE\OneDrive\Desktop\Tài liệu bài tập .net\4_DTNhatNMPhuongPTNguyenNVNam_LTNET\4_DTNhatNMPhuongPTNguyenNVNam_LTNET\Image\man.png");
                btnPhong.Left = posX;
                ...
                if (phong[1].Equals("True", StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    btnPhong.MouseEnter += (sender, e) => { btnPhong.BackColor = Color.Red; };
                    // Xử lý sự kiện khi di chuột ra
                    btnPhong.MouseLeave += (sender, e) => { btnPhong.BackColor = Color.Red; };
