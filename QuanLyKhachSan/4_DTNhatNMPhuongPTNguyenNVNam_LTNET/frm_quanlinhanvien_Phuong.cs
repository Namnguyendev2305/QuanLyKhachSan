        ...
        private void btn_them_Nhat_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string sql1 = "insert into Nhavien values('" + txt_manv_Nam.Text + "',N'" + txt_tennv_Nam.Text + "','"+ txt_ngaysinh_Nam.Value + "',N'" + txt_gioitinh_Nam.Text + "','" + mahoamk + "',N'" + txt_loai_nam.Text + "',N'" + txt_user_Nam.Text + "',N'"+null+"')";
                    cnn.ThucthiDL(sql1);
