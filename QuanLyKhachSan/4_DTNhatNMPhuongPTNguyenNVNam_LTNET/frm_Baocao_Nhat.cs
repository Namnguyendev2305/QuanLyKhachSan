...
namespace _4_DTNhatNMPhuongPTNguyenNVNam_LTNET
{
    public partial class frm_Baocao_Nhat : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'qlkhachsanDataSet.View_Baocao' table. You can move, or remove it, as needed.
            this.View_BaocaoTableAdapter.Fill(this.qlkhachsanDataSet.View_Baocao);
